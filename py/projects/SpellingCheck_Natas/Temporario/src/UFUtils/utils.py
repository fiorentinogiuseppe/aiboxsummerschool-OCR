...
def predict_word(text_original, predictions, maskids, tokenizer, suggestedwords):
    ...
    for i in range(len(maskids)):
        ...
        text_original = text_original.replace('[MASK]', re.sub('[^a-zA-Z0-9]+', '', predicted_token), 1)
...
def correct_spell(text):
    ...
    text_original = utils.predict_word(text_original, predictions, MASKIDS, tokenizer, suggestedwords)
    return text_original
